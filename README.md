...
|------------|------------|--------------|----------------------------------------------|
|   매장 개발    | 정안식     | 팀장 (PL)  | 팀원 코드 피드백, 프로젝트 구조 설계 및 서류 작성 |
|               |            |           | 데이터 이중화 모듈, 매장 발주/입고/재고 시스템 개발, 프론트엔드 일부 작업 |
|   매장 개발    | 박시연     | 팀원       | 로그인 모듈, 매장 고객 로그인 시스템 개발 |
|   매장 개발    | 현영은     | 팀원       | 암호화 모듈, 매장 구매/판매 시스템 개발 |
| 영업 본부 개발 | 함예정     | 팀장 (PL)  | 팀원 코드 피드백, 프로젝트 구조 설계 및 서류 작성, GIT 설계 |
|               |            |           | 하신 일을 적어 주세요 |
